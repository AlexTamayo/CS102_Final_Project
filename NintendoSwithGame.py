...
class NintendoSwitchGame:
    def __init__(
        ...
        publisher,
        developer,
        single_player_and_cat=None,
        multiplayer_type=None,
        age_rating=None,
    ):
    ...
    def type_of_game(self):
        ...
        if self.is_single_player():
            ...
            categories_singleP.append("Single Player")
        ...
        if self.is_multi_player():
            ...
            categories_multiP.append("Multiplayer")
...
if __name__ == "__main__":
    ...
    game_00007 = NintendoSwitchGame(
        "Fire Emblem Warriors: Three Hopes",
        [[2022, 6, 24]],
        "Nintendo",
        "Omega Force",
        ["Hack and slash", "Action role-playing", "Real-time tactics"],
        ["Split Screen", "Co-Op"],
    )
    game_00008 = NintendoSwitchGame(
        "Hyrule Warriors: Age of Calamity",
        [[2020, 11, 20]],
        "Nintendo",
        "Omega Force",
        ["Hack and slash", "Action role-playing"],
        ["Split Screen", "Co-Op"],
    )
    game_00009 = NintendoSwitchGame(
