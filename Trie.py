...
class Trie:
    ...
    def search(self, prefix):
        ...
        self._search_helper(
            node, prefix, results
        )  # call the helper function to search for the words
    ...
    def _search_helper(self, node, prefix, results):
        ...
        for child_char in node.children.keys():
            ...
            self._search_helper(node.children[child_char], prefix + child_char, results)
