...
my_games_list.append(
    NintendoSwitchGame(
        ...
        ["Nintendo"],
        ["Omega Force"],
        ["Hack and Slash", "Action", "RPG", "Real-time tactics"],
        ["Split Screen", "Co-Op"],
    )
)
my_games_list.append(
...
my_games_list.append(
    NintendoSwitchGame(
        "Ori Collector's Edition: Ori the Collection",
        [[2021, 10, 21]],
        ["Xbox Game Studios"],
        ["Moon Studios"],
...
my_games_list.append(
    NintendoSwitchGame(
        ...
        [[2020, 9, 18]],
        ["Nintendo"],
        ["Nintendo EPD", "1-Up Studio", "Nintendo European Research & Development"],
...
my_games_list.append(
    NintendoSwitchGame(
        ...
        ["Nintendo"],
        ["Retro Studios"],
        ["Adventure", "Action", "First Person", "Platformer", "Metroidvania"],
    )
)
